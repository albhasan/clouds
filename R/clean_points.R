# Make a clean copy of the classified points for cross classification
library(dplyr)
library(sf)

out_dir <- "/home/alber/Documents/data/experiments/prodes_reproduction/papers/clouds/data/samples/cross_classification_clean"
...
cloud_experts <- "/home/alber/Documents/data/experiments/prodes_reproduction/papers/clouds" %>%
